...
<div id="canvas">
	...
	<div id="isi">
		<fieldset>
	<legend>Tambah Item</legend>
	<form method="POST" enctype="multipart/form-data">
		<table>
			<tr>
				<td>Nama Item</td>
				<td>:</td>
				<td><input type="text" name="nama" placeholder="Nama Item .."></td>
			</tr>
			...
			<tr>
				...
				<td>:</td>
				<td>
					<textarea name="sejarah" placeholder="Sejarah .."></textarea>
				</td>
			</tr>
			...
			<tr>
				...
				<td>:</td>
				<td>
					<textarea name="deskripsi" placeholder="Deksripsi .."></textarea>
				</td>
			</tr>
